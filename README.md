...
- `v1.0.9` adapts applicable Pool `v1.1.2` primitives to Store: a DRY XML/text sitemap source plus deployed crawl audit, crawl-stable modification dates, a localized lazy admin review bundle, explicit policy navigation and final-sale checkout disclosure, and a regression guard for the protected recovery dependency path.
