...
- Added a dedicated rate-limited `WORKERS_CACHE_EVIDENCE_SECRET` probe that returns two-read metrics without Store rows, plus a nightly low-traffic GitHub Actions collector for aggregate cache ratios and sanitized evidence.
