...
- Published tags are immutable. The Storefront, Worker, canonical configuration, release notes, and evidence are packaged as `v1.0.8` after the reviewed production and protected-operations proof.
