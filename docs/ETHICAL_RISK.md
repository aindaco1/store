...
- **Final-sale pressure and consumer harm:** A no-returns default can be misleading or used to deny remedies for Store error, damaged/defective/incorrect/missing goods, delayed/canceled fulfillment, duplicate charges, fraud, or rights supplied by law. Mitigation: stable localized policy links and the pre-payment checkout notice disclose final-sale status; Terms preserve those separate remedies and make the seven-day damage-report request a verification guideline rather than a waiver. Residual owner: Store operator/legal reviewer, reviewed 2026-07-14.
