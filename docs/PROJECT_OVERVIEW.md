...
Current release: `v1.1.14`. The preceding `v1.1.13` release remains independently reversible. Store pins Platform v0.25.0 and consumes bounded durable-outbox mechanics without moving KV ownership, templates, suppression, provider scheduling/sends, order effects, credentials, deployment, or rollback authority out of Store.
