...
Current release: `v1.1.11`. The preceding `v1.1.10` release remains independently reversible. Store pins Platform v0.22.0 and consumes bounded USPS transport plus the canonical shipping-country snapshot without moving address/product policy, credentials, checkout/fulfillment effects, deployment, or rollback authority out of Store.
