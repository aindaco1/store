...
Current release: `v1.1.15`. The preceding `v1.1.14` release remains independently reversible. Store pins Platform v0.26.0 and consumes framework-neutral browser-test setup and mobile overflow mechanics without moving fixtures, URLs, viewports, responsive/product assertions, CI, deployment, or rollback authority out of Store.
