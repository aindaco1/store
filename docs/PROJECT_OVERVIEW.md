...
Current release: `v1.1.13`. The preceding `v1.1.12` release remains independently reversible. Store pins Platform v0.24.0 and consumes bounded tax-provider transport without moving provider/fallback policy, product taxability, quote calculation, credentials, checkout effects, deployment, or rollback authority out of Store.
