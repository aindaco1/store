...
Current release: `v1.1.12`. The preceding `v1.1.11` release remains independently reversible. Store pins Platform v0.23.0 and consumes bounded GitHub transport without moving repository/product policy, credentials, publishing effects, deployment, or rollback authority out of Store.
